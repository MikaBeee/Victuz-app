...
namespace Victuz.Controllers.DataController
{
    ...
    public class LocationsController : Controller
    {
        ...
        public async Task<List<LocationVM>> AllLocation()
        {
            var victuzDB = _context.location
        ...
        public async Task<IActionResult> Create([Bind("LocId,LocName")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocId,LocName")] Location location)
        {
